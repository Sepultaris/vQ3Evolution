# Inherited vkQuake3 Vulkan backend notes

These upstream notes are retained for provenance, not as a description of the
current VQ3 Evolution renderer. Interfaces, resource lifetimes, pipeline layout
and rendering passes have changed substantially. See the
[current backend overview](../../code/renderer_vulkan/README.md).
