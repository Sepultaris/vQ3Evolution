...
| Ray scene, acceleration structures and hybrid shadows | `vk_raytracing.c`, `shaders/rt_shadows.comp` |
...
Raster, ray-shadow and path-traced modes share the renderer's scene submission
