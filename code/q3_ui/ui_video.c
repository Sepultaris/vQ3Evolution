...
#define ID_RATIO		110
#define ID_HUDSCALE		111
#define ID_UISCALE		112
#define ID_DLSS			113
	...
	else
	{
		...
		if ( s_graphicsoptions.filter.curvalue >= 2 )
		{
			...
			trap_Cvar_SetValue( "r_ext_max_anisotropy",
				1 << (s_graphicsoptions.filter.curvalue - 1) );
		}
		else
		{
			trap_Cvar_SetValue( "r_ext_texture_filter_anisotropic", 0 );
...
/*
================
GraphicsOptions_ScaleEvent
================
*/
static void GraphicsOptions_ScaleEvent( void *ptr, int event ) {
	menuslider_s *slider;
	int value;
	...
	if ( slider->generic.id == ID_HUDSCALE ) {
		trap_Cvar_SetValue( "cg_hudScale", value * 0.1f );
	} else {
		trap_Cvar_SetValue( "ui_scale", value * 0.1f );
	}
}
...
/*
================
GraphicsOptions_DLSSSharpnessEvent
================
*/
static void GraphicsOptions_DLSSSharpnessEvent( void *ptr, int event ) {
	menuslider_s *slider;
	int value;
...
//APSFIX - rework this
	...
	UI_DrawString( 520, s_graphicsoptions.hudscale.generic.y,
		va( "%i%%", (int)s_graphicsoptions.hudscale.curvalue * 10 ),
		UI_LEFT|UI_SMALLFONT, text_color_normal );
	UI_DrawString( 520, s_graphicsoptions.uiscale.generic.y,
		va( "%i%%", (int)s_graphicsoptions.uiscale.curvalue * 10 ),
		UI_LEFT|UI_SMALLFONT, text_color_normal );
...
static void GraphicsOptions_SetMenuItems( void )
{
	...
	{
		int anisotropy = (int)trap_Cvar_VariableValue( "r_ext_max_anisotropy" );
		if ( anisotropy <= 2 )
	...
	s_graphicsoptions.hudscale.curvalue =
		Com_Clamp( 5, 15, trap_Cvar_VariableValue( "cg_hudScale" ) * 10.0f );
	s_graphicsoptions.uiscale.curvalue =
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.hudscale.generic.x        = 400;
	s_graphicsoptions.hudscale.generic.y        = y;
	s_graphicsoptions.hudscale.generic.id       = ID_HUDSCALE;
	s_graphicsoptions.hudscale.generic.callback = GraphicsOptions_ScaleEvent;
	s_graphicsoptions.hudscale.minvalue         = 5;
	s_graphicsoptions.hudscale.maxvalue         = 15;
	y += BIGCHAR_HEIGHT+2;

	s_graphicsoptions.uiscale.generic.type     = MTYPE_SLIDER;
	s_graphicsoptions.uiscale.generic.name     = "UI Scale:";
	s_graphicsoptions.uiscale.generic.flags    = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.uiscale.generic.x        = 400;
	s_graphicsoptions.uiscale.generic.y        = y;
	s_graphicsoptions.uiscale.generic.id       = ID_UISCALE;
	s_graphicsoptions.uiscale.generic.callback = GraphicsOptions_ScaleEvent;
	s_graphicsoptions.uiscale.minvalue         = 5;
	s_graphicsoptions.uiscale.maxvalue         = 15;
	y += BIGCHAR_HEIGHT+2;
	...
	s_graphicsoptions.dlsssharpness.generic.name     = "DLSS Sharpness:";
	s_graphicsoptions.dlsssharpness.generic.flags    = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.dlsssharpness.generic.x        = 400;
	s_graphicsoptions.dlsssharpness.generic.y        = y;
	s_graphicsoptions.dlsssharpness.generic.id       = ID_DLSSSHARPNESS;
	s_graphicsoptions.dlsssharpness.generic.callback = GraphicsOptions_DLSSSharpnessEvent;
	s_graphicsoptions.dlsssharpness.minvalue         = 0;
	...
	s_graphicsoptions.dlssfg.generic.x       = 400;
	...
	s_graphicsoptions.reflex.generic.name    = "NVIDIA Reflex:";
	s_graphicsoptions.reflex.generic.flags   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.reflex.generic.x       = 400;
	s_graphicsoptions.reflex.generic.y       = y;
	s_graphicsoptions.reflex.generic.id      = ID_REFLEX;
	s_graphicsoptions.reflex.itemnames       = reflex_names;
	y += 12;
