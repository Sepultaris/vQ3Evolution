...
void CL_InitCGame( void ) {
	...
	localServer = (com_sv_running && com_sv_running->integer) ||
		NET_IsLocalAddress( clc.serverAddress );
	if(cl_connectedToPureServer && !localServer)
	{
	...
	cgvm = VM_Create( "cgame", CL_CgameSystemCalls, interpret, localServer );
	if ( !cgvm ) {
