...
static void SV_VerifyPaks_f( client_t *cl ) {
	...
	if ( sv_pure->integer != 0 ) {
		// The in-process client may intentionally use freshly built loose VMs.
		// This exemption is restricted to the engine's loopback transport;
		// network clients still have to pass the complete pure-pak validation.
